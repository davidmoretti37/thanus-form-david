...
class AgentsClient:
    """SDK client for InventuAI Agents API with httpx client supporting custom headers"""
    ...
    def __init__(
        ...
        Args:
            base_url: Base URL of the API (e.g., "https://api.tars.ai/api")
...
client = create_agents_client(
    base_url="https://api.tars.ai/api",
