# Thanus Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of Thanus, an open-source generalist AI agent.
...
- Start Thanus using your preferred method
...
3. Create a Docker image:
   - Image name: `InventuAI/Thanus:0.1.3`
...
Thanus can be started in two ways:
...
For further assistance, join the [Thanus Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/InventuAI-ai/Thanus) for updates and issues.
