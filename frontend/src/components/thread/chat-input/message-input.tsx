        ...
        <div className="flex items-center justify-between mt-1 ml-3 mb-1 pr-2">
          ...
          {subscriptionStatus === 'no_subscription' && !isLocalMode() &&
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>The free tier is severely limited by inferior models; upgrade to experience the true full Thanus experience.</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          }
          <div className='flex items-center gap-2'>
            ...
            <Button
              ...
              size="sm"
              className={cn(
                'w-5 h-5 flex-shrink-0 self-end',
                isAgentRunning ? 'bg-red-500/60 hover:bg-red-500/70' : '',
