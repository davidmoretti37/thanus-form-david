            ...
            <TooltipTrigger asChild>
              <span className="inline-block">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  aria-label={isLoggedIn ? 'Attach files' : 'Please login to attach files'}
                  className="h-8 w-8 p-0 bg-transparent border border-border rounded-xl text-muted-foreground hover:text-foreground hover:bg-accent/50 flex items-center justify-center"
                  disabled={
