...
import { FloatingSidebarWrapper } from '@/components/floating-sidebar/FloatingSidebarWrapper';
...
export const metadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Tars - Open Source Generalist AI Worker',
        type: 'image/png',
      },
    ],
    locale: 'en_US',
  ...
  icons: {
    icon: [{ url: '/kortix-symbol.svg', sizes: 'any' }],
    shortcut: '/kortix-symbol.svg',
    apple: '/kortix-symbol.svg',
  },
