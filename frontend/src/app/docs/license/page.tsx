...
export default function LicensePage() {
  return (
    <>
      <DocsHeader
        title="License"
        description="Tars is open source software licensed under the Apache License, Version 2.0"
      ...
      <DocsBody className="w-full h-[40vh] px-8 py-16 relative overflow-hidden rounded-3xl flex items-center justify-center border bg-background mb-12">
        <h1 className="text-xl tracking-tight text-foreground text-center">
            <span className="font-semibold text-3xl">Tars is open source under the Apache 2.0 License. You can see the source code, self-host & contribute.</span>
        </h1> 
        <Ripple/>
      </DocsBody>
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Tars is distributed under the Apache License 2.0, one of the most permissive and business-friendly open source licenses available.
            This license allows you to use, modify, distribute, and sublicense Tars for both commercial and non-commercial purposes.
          </p>
        </DocsBody>
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="check" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="Use Tars for commercial purposes without any fees or royalties"
          />
          <DocsBulletItem
            title="Modification"
          ...
          <DocsBulletItem
            title="Distribution"
            description="Distribute original or modified versions of Tars"
          />
          <DocsBulletItem
            title="Patent Use"
          ...
          <DocsBulletItem
            title="Private Use"
            description="Use and modify Tars for private purposes without any obligations"
          />
          <DocsBulletItem
            title="Sublicensing"
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            When using Tars under the Apache License 2.0, you must:
          </p>
        </DocsBody>
      ...
      <section className="mb-12">
        ...
        <DocsBullets variant="default" spacing="default" className="mb-8">
          <DocsBulletItem
            ...
            description="The license does not grant permission to use the trade names, trademarks, or service marks of Tars"
          />
          <DocsBulletItem
            title="No Warranty"
        ...
        <Alert className="mb-8">
          <AlertDescription>
            <strong>Patent Retaliation Clause:</strong> If you initiate patent litigation against any entity alleging that Tars constitutes patent infringement, 
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="border-l-4 border-primary pl-6">
            <h3 className="font-semibold mb-2">Can I use Tars in my commercial product?</h3>
          ...
          <div className="border-l-4 border-primary pl-6">
            ...
            <p className="text-muted-foreground">
              You can apply different license terms to your modifications, but the original Tars code remains under Apache 2.0.
            </p>
          </div>
      ...
      <section className="mb-12">
        <DocsBody className="mb-8">
          ...
          <p className="text-lg mb-6">
            Learn more about the Apache License 2.0 and how to use Tars:
          </p>
        </DocsBody>
