...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kortix Tars',
    description: 'Replay this Agent conversation on Kortix Tars',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kortix Tars';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Kortix Tars';
