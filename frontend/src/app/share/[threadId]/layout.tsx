...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | InventuAI Thanus',
    description: 'Replay this Agent conversation on InventuAI Thanus',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | InventuAI Thanus';
    const description =
      projectData.description ||
      'Replay this Agent conversation on InventuAI Thanus';
