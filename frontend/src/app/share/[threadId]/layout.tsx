...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Tars',
    description: 'Replay this Agent conversation on Tars',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Tars';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Tars';
