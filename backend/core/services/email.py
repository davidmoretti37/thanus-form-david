...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'tars@inventu.ai')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Tars Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Tars — Let's Get Started "
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Tars Logo" class="logo">
    </div>
    <h1>Welcome to Tars!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Tars — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Tars community <span class="emoji">🌞</span></p>

    <p>— The Tars Team</p>

    <a href="https://www.tars.ai/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Tars — we're excited to have you on board!
...
For your business: if you want to automate manual and ordinary tasks for your company, book a call with us here: https://cal.com/team/tars/enterprise-demo 

Thanks again, and welcome to the Tars community 🌞

— The Tars Team

Go to the platform: https://www.tars.ai/

---
© 2025 Tars. All rights reserved.
You received this email because you signed up for a Tars account."""
