...
class SandboxWebSearchTool(SandboxToolsBase):
    ...
    @usage_example('''
        ...
        <parameter name="query">what is Tars AI and what are they building?</parameter>
    ...
    @usage_example('''
        ...
        <parameter name="urls">https://www.tars.ai/,https://github.com/inventu-ai/tars</parameter>
        </invoke>
        </function_calls>
