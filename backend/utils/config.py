...
class Configuration:
    ...
    STRIPE_TIER_2_20_ID_PROD: str = 'price_1RRdisLBmRtPsC5qj7taJxv7'
    STRIPE_TIER_6_50_ID_PROD: str = 'price_1RRdisLBmRtPsC5qtpU5m1x2'
    STRIPE_TIER_12_100_ID_PROD: str = 'price_1RRggLLBmRtPsC5qa1cd0O2l'
    STRIPE_TIER_25_200_ID_PROD: str = 'price_1RRggLLBmRtPsC5qqZbr8TXc'
    STRIPE_TIER_50_400_ID_PROD: str = 'price_1RRggLLBmRtPsC5qjQ5TT06E'
    STRIPE_TIER_125_800_ID_PROD: str = 'price_1RRggLLBmRtPsC5qyorctNr3'
    STRIPE_TIER_200_1000_ID_PROD: str = 'price_1RRggLLBmRtPsC5q7NZkLA5p'
    
    # Subscription tier IDs - Staging
    STRIPE_FREE_TIER_ID_STAGING: str = ''
    STRIPE_TIER_2_20_ID_STAGING: str = 'price_1RRdisLBmRtPsC5qj7taJxv7'
    STRIPE_TIER_6_50_ID_STAGING: str = 'price_1RRdisLBmRtPsC5qtpU5m1x2'
    STRIPE_TIER_12_100_ID_STAGING: str = 'price_1RRggLLBmRtPsC5qa1cd0O2l'
    STRIPE_TIER_25_200_ID_STAGING: str = 'price_1RRggLLBmRtPsC5qqZbr8TXc'
    STRIPE_TIER_50_400_ID_STAGING: str = 'price_1RRggLLBmRtPsC5qjQ5TT06E'
    STRIPE_TIER_125_800_ID_STAGING: str = 'price_1RRggLLBmRtPsC5qyorctNr3'
    STRIPE_TIER_200_1000_ID_STAGING: str = 'price_1RRggLLBmRtPsC5q7NZkLA5p'
    ...
    OR_SITE_URL: Optional[str] = "https://InventuAI.ai"
    OR_APP_NAME: Optional[str] = "InventuAI AI"    
