...
class SandboxWebSearchTool(SandboxToolsBase):
    ...
    @xml_schema(
        ...
        <parameter name="query">what is InventuAI AI and what are they building?</parameter>
    ...
    @xml_schema(
        ...
        <parameter name="urls">https://www.InventuAI.ai/,https://github.com/InventuAI-ai/Thanus</parameter>
        </invoke>
        </function_calls>
        '''
    )
